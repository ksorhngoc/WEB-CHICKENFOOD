...
<body background="../images/background3.jpg">
    ...
    <div class = "main" style="width: 99%; border: 2px solid white; margin: auto;">
        ...
        <a href="index.php?action=sanPham&thongTin=thongTinSP&ma=0"><button class="btnDonHang" id="sanPham"><b>Sản phẩm</b></button></a>
        <a href="index.php?action=nhanVien&thongTin=thongTinNhanVien&ma=0"><button class="btnDonHang" id="nhanVien"><b>Nhân viên</b></button></a>
        <a href="index.php?action=taiKhoan&thongTin=thongTinTaiKhoan"><button class="btnDonHang" id="TaiKhoan"><b>Tài khoản</b></button></a>
        <a href="index.php?action=doanhThu"><button class="btnDonHang" id="doanhThu"><b>Doanh Thu</b></button></a>
        <a href="index.php?action=lichSuDonHang"><button class="btnDonHang" id="LichSuDH"><b>Lịch sử đơn hàng </b></button></a>
        <a href="index.php?action=tuyenDung"><button class="btnDonHang" id="Tuyển dụng"><b>Tuyển Dụng</b></button></a>
        <a href="index.php?action=saoLuu"><button class="btnDonHang" id="saoLuu"><b>Sao lưu & Phục hồi</b></button></a>
        <a href="index.php?action=quangCao"><button class="btnDonHang" id="QuangCao"><b>Quảng cáo</b></button></a>
