...
<center><div style=" width: 600; height: 400; background: #FFCC99; margin">
    ...
    <br></br>
    <form action= "index.php?action=xacNhanDonDangGiao&ma=<?php echo $ma_dh ?>" method="post">
    <input type="radio" name="trangThai" value="6"/><b>Giao thành công</b>
    <input  style="margin-left: 100px" type="radio" name="trangThai" value="7"/><b>Giao không thành công</b>
    ...
    <a href="index.php?action=donHangDangGiao"><button style=" float: left; width: 100px ; height: 30px ; border: 2px solid black; margin: -70 130; background:#CC0000;color: white" >Quay về</button></a>
...
<?php 
    if(isset($_POST["capNhat"])){
        ...
        if($trangThai == '6'){
            ...
            $sql = "UPDATE donhang SET trangThai = '7' where maDH = '$ma_dh' ";
		    $KQ = $conn->query($sql);
        }
        else{
